...
contract BorrowerOperationsTest is DevTestSetup {
    function testCloseLastTroveReverts() public {
        ...
        deal(address(ebusdToken), A, aliceDebt);
    ...
    function testRepayingTooMuchDebtCapsAtMinDebt() public {
        ...
        deal(address(ebusdToken), A, 3_000 ether);
        vm.prank(A);
        borrowerOperations.repayEbusd(troveId, 3_000 ether);
    ...
    function testOpenTroveChargesUpfrontFee() public {
        ...
        uint256 activePoolDebtBefore = activePool.getEbusdDebt();
        ...
        uint256 activePoolDebtAfter = activePool.getEbusdDebt();
    ...
    function testWithdrawEbusdChargesUpfrontFee() public {
        ...
        vm.prank(A);
        borrowerOperations.withdrawEbusd(troveId, withdrawal, upfrontFee);
    ...
    function testWithdrawEbusdRevertsIfUpfrontFeeExceedsUserProvidedLimit() public {
        uint256 troveId = openTroveNoHints100pct(A, 100 ether, 10_000 ether, 0.05 ether);
        ...
        vm.prank(A);
        vm.expectRevert(BorrowerOperations.UpfrontFeeTooHigh.selector);
        borrowerOperations.withdrawEbusd(troveId, withdrawal, upfrontFee - 1);
    }
    ...
    function testAdjustInterestRateChargesUpfrontFeeWhenPremature() public {
        ...
        activePoolDebtBefore = activePool.getEbusdDebt();
        ...
        activePoolDebtAfter = activePool.getEbusdDebt();
