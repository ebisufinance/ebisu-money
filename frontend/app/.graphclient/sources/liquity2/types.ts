...
export namespace Liquity2Types {
  ...
  export type QuerySdk = {
    ...
    /** null **/
    collateralAddresses_collection: InContextSdkMethod<
      Query["collateralAddresses_collection"],
      QuerycollateralAddresses_collectionArgs,
      MeshContext
    >;
    /** null **/
    ...
    /** null **/
    stabilityPoolDeposits: InContextSdkMethod<
      Query["stabilityPoolDeposits"],
      QuerystabilityPoolDepositsArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
  ...
  export type SubscriptionSdk = {
    ...
    /** null **/
    collateralAddresses: InContextSdkMethod<
      Subscription["collateralAddresses"],
      SubscriptioncollateralAddressesArgs,
      MeshContext
    >;
    /** null **/
    collateralAddresses_collection: InContextSdkMethod<
      Subscription["collateralAddresses_collection"],
      SubscriptioncollateralAddresses_collectionArgs,
      MeshContext
    >;
    /** null **/
    interestRateBracket: InContextSdkMethod<
      Subscription["interestRateBracket"],
      SubscriptioninterestRateBracketArgs,
      MeshContext
    >;
    /** null **/
    interestRateBrackets: InContextSdkMethod<
      Subscription["interestRateBrackets"],
      SubscriptioninterestRateBracketsArgs,
      MeshContext
    >;
    /** null **/
    ...
    /** null **/
    stabilityPoolDeposit: InContextSdkMethod<
      Subscription["stabilityPoolDeposit"],
      SubscriptionstabilityPoolDepositArgs,
      MeshContext
    >;
    /** null **/
    stabilityPoolDeposits: InContextSdkMethod<
      Subscription["stabilityPoolDeposits"],
      SubscriptionstabilityPoolDepositsArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
