...
export type entityDirectiveResolver<Result, Parent, ContextType = MeshContext, Args = entityDirectiveArgs> =
...
export type subgraphIdDirectiveResolver<Result, Parent, ContextType = MeshContext, Args = subgraphIdDirectiveArgs> =
  DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type derivedFromDirectiveResolver<Result, Parent, ContextType = MeshContext, Args = derivedFromDirectiveArgs> =
  DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type BorrowerInfoResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["BorrowerInfo"] = ResolversParentTypes["BorrowerInfo"],
> = ResolversObject<{
...
export type CollateralResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["Collateral"] = ResolversParentTypes["Collateral"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  ...
  troves?: Resolver<
    ReadonlyArray<ResolversTypes["Trove"]>,
    ParentType,
    ContextType,
    RequireFields<CollateraltrovesArgs, "skip" | "first">
  >;
  addresses?: Resolver<ResolversTypes["CollateralAddresses"], ParentType, ContextType>;
  stabilityPoolDeposits?: Resolver<
    ReadonlyArray<ResolversTypes["StabilityPoolDeposit"]>,
    ParentType,
    ContextType,
    RequireFields<CollateralstabilityPoolDepositsArgs, "skip" | "first">
  >;
...
export type CollateralAddressesResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["CollateralAddresses"] = ResolversParentTypes["CollateralAddresses"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type InterestRateBracketResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["InterestRateBracket"] = ResolversParentTypes["InterestRateBracket"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
> = ResolversObject<{
  collateral?: Resolver<
    Maybe<ResolversTypes["Collateral"]>,
    ParentType,
    ContextType,
    RequireFields<QuerycollateralArgs, "id" | "subgraphError">
  >;
  collaterals?: Resolver<
    ReadonlyArray<ResolversTypes["Collateral"]>,
    ParentType,
    ContextType,
    RequireFields<QuerycollateralsArgs, "skip" | "first" | "subgraphError">
  >;
  token?: Resolver<
  ...
  >;
  tokens?: Resolver<
    ReadonlyArray<ResolversTypes["Token"]>,
    ParentType,
    ContextType,
    RequireFields<QuerytokensArgs, "skip" | "first" | "subgraphError">
  >;
  collateralAddresses?: Resolver<
    Maybe<ResolversTypes["CollateralAddresses"]>,
    ParentType,
    ContextType,
    RequireFields<QuerycollateralAddressesArgs, "id" | "subgraphError">
  >;
  collateralAddresses_collection?: Resolver<
    ReadonlyArray<ResolversTypes["CollateralAddresses"]>,
    ParentType,
    ContextType,
    RequireFields<QuerycollateralAddresses_collectionArgs, "skip" | "first" | "subgraphError">
  >;
  interestRateBracket?: Resolver<
    Maybe<ResolversTypes["InterestRateBracket"]>,
    ParentType,
    ContextType,
    RequireFields<QueryinterestRateBracketArgs, "id" | "subgraphError">
  >;
  interestRateBrackets?: Resolver<
    ReadonlyArray<ResolversTypes["InterestRateBracket"]>,
    ParentType,
    ContextType,
    RequireFields<QueryinterestRateBracketsArgs, "skip" | "first" | "subgraphError">
  >;
  trove?: Resolver<
    Maybe<ResolversTypes["Trove"]>,
    ParentType,
    ContextType,
    RequireFields<QuerytroveArgs, "id" | "subgraphError">
  >;
  troves?: Resolver<
    ReadonlyArray<ResolversTypes["Trove"]>,
    ParentType,
    ContextType,
    RequireFields<QuerytrovesArgs, "skip" | "first" | "subgraphError">
  >;
  borrowerInfo?: Resolver<
    Maybe<ResolversTypes["BorrowerInfo"]>,
    ParentType,
    ContextType,
    RequireFields<QueryborrowerInfoArgs, "id" | "subgraphError">
  >;
  borrowerInfos?: Resolver<
    ReadonlyArray<ResolversTypes["BorrowerInfo"]>,
    ParentType,
    ContextType,
    RequireFields<QueryborrowerInfosArgs, "skip" | "first" | "subgraphError">
  >;
  stabilityPool?: Resolver<
    Maybe<ResolversTypes["StabilityPool"]>,
    ParentType,
    ContextType,
    RequireFields<QuerystabilityPoolArgs, "id" | "subgraphError">
  >;
  stabilityPools?: Resolver<
    ReadonlyArray<ResolversTypes["StabilityPool"]>,
    ParentType,
    ContextType,
    RequireFields<QuerystabilityPoolsArgs, "skip" | "first" | "subgraphError">
  >;
  stabilityPoolDeposit?: Resolver<
    Maybe<ResolversTypes["StabilityPoolDeposit"]>,
    ParentType,
    ContextType,
    RequireFields<QuerystabilityPoolDepositArgs, "id" | "subgraphError">
  >;
  stabilityPoolDeposits?: Resolver<
    ReadonlyArray<ResolversTypes["StabilityPoolDeposit"]>,
    ParentType,
    ContextType,
    RequireFields<QuerystabilityPoolDepositsArgs, "skip" | "first" | "subgraphError">
  >;
  _meta?: Resolver<Maybe<ResolversTypes["_Meta_"]>, ParentType, ContextType, Partial<Query_metaArgs>>;
}>;

export type StabilityPoolResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["StabilityPool"] = ResolversParentTypes["StabilityPool"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  totalDeposited?: Resolver<ResolversTypes["BigInt"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type StabilityPoolDepositResolvers<
  ContextType = MeshContext,
...
> = ResolversObject<{
  collateral?: SubscriptionResolver<
    Maybe<ResolversTypes["Collateral"]>,
    "collateral",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncollateralArgs, "id" | "subgraphError">
  >;
  collaterals?: SubscriptionResolver<
    ReadonlyArray<ResolversTypes["Collateral"]>,
    "collaterals",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncollateralsArgs, "skip" | "first" | "subgraphError">
  >;
  ...
  >;
  collateralAddresses?: SubscriptionResolver<
    Maybe<ResolversTypes["CollateralAddresses"]>,
    "collateralAddresses",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncollateralAddressesArgs, "id" | "subgraphError">
  >;
  collateralAddresses_collection?: SubscriptionResolver<
    ReadonlyArray<ResolversTypes["CollateralAddresses"]>,
    "collateralAddresses_collection",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncollateralAddresses_collectionArgs, "skip" | "first" | "subgraphError">
  >;
  interestRateBracket?: SubscriptionResolver<
    Maybe<ResolversTypes["InterestRateBracket"]>,
    "interestRateBracket",
    ParentType,
    ContextType,
    RequireFields<SubscriptioninterestRateBracketArgs, "id" | "subgraphError">
  >;
  interestRateBrackets?: SubscriptionResolver<
    ReadonlyArray<ResolversTypes["InterestRateBracket"]>,
    "interestRateBrackets",
    ParentType,
    ContextType,
    RequireFields<SubscriptioninterestRateBracketsArgs, "skip" | "first" | "subgraphError">
  >;
  trove?: SubscriptionResolver<
    Maybe<ResolversTypes["Trove"]>,
    "trove",
    ParentType,
    ContextType,
    RequireFields<SubscriptiontroveArgs, "id" | "subgraphError">
  >;
  troves?: SubscriptionResolver<
    ReadonlyArray<ResolversTypes["Trove"]>,
    "troves",
    ParentType,
    ContextType,
    RequireFields<SubscriptiontrovesArgs, "skip" | "first" | "subgraphError">
  >;
  borrowerInfo?: SubscriptionResolver<
    Maybe<ResolversTypes["BorrowerInfo"]>,
    "borrowerInfo",
    ParentType,
    ContextType,
    RequireFields<SubscriptionborrowerInfoArgs, "id" | "subgraphError">
  >;
  borrowerInfos?: SubscriptionResolver<
    ReadonlyArray<ResolversTypes["BorrowerInfo"]>,
    "borrowerInfos",
    ParentType,
    ContextType,
    RequireFields<SubscriptionborrowerInfosArgs, "skip" | "first" | "subgraphError">
  >;
  stabilityPool?: SubscriptionResolver<
    Maybe<ResolversTypes["StabilityPool"]>,
    "stabilityPool",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstabilityPoolArgs, "id" | "subgraphError">
  >;
  stabilityPools?: SubscriptionResolver<
    ReadonlyArray<ResolversTypes["StabilityPool"]>,
    "stabilityPools",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstabilityPoolsArgs, "skip" | "first" | "subgraphError">
  >;
  stabilityPoolDeposit?: SubscriptionResolver<
    Maybe<ResolversTypes["StabilityPoolDeposit"]>,
    "stabilityPoolDeposit",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstabilityPoolDepositArgs, "id" | "subgraphError">
  >;
  stabilityPoolDeposits?: SubscriptionResolver<
    ReadonlyArray<ResolversTypes["StabilityPoolDeposit"]>,
    "stabilityPoolDeposits",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstabilityPoolDepositsArgs, "skip" | "first" | "subgraphError">
  >;
...
export type TroveResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["Trove"] = ResolversParentTypes["Trove"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  const relativeModuleId = (pathModule.isAbsolute(moduleId) ? pathModule.relative(baseDir, moduleId) : moduleId).split(
    "\\",
  ).join("/").replace(baseDir + "/", "");
...
export type TrovesByAccountQuery = {
  readonly troves: ReadonlyArray<
    (
      & Pick<
        Trove,
        "id" | "troveId" | "borrower" | "debt" | "deposit" | "stake" | "interestRate" | "createdAt" | "closedAt"
      >
      & {
        readonly collateral:
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    TrovesByAccount(variables: TrovesByAccountQueryVariables, options?: C): Promise<TrovesByAccountQuery> {
      return requester<TrovesByAccountQuery, TrovesByAccountQueryVariables>(
        TrovesByAccountDocument,
        variables,
        options,
      ) as Promise<TrovesByAccountQuery>;
    },
    TrovesCount(variables: TrovesCountQueryVariables, options?: C): Promise<TrovesCountQuery> {
      return requester<TrovesCountQuery, TrovesCountQueryVariables>(TrovesCountDocument, variables, options) as Promise<
        TrovesCountQuery
      >;
    },
    TroveById(variables: TroveByIdQueryVariables, options?: C): Promise<TroveByIdQuery> {
      return requester<TroveByIdQuery, TroveByIdQueryVariables>(TroveByIdDocument, variables, options) as Promise<
        TroveByIdQuery
      >;
    },
    StabilityPoolDepositsByAccount(
      variables: StabilityPoolDepositsByAccountQueryVariables,
      options?: C,
    ): Promise<StabilityPoolDepositsByAccountQuery> {
      return requester<StabilityPoolDepositsByAccountQuery, StabilityPoolDepositsByAccountQueryVariables>(
        StabilityPoolDepositsByAccountDocument,
        variables,
        options,
      ) as Promise<StabilityPoolDepositsByAccountQuery>;
    },
    StabilityPoolDeposit(
      variables: StabilityPoolDepositQueryVariables,
      options?: C,
    ): Promise<StabilityPoolDepositQuery> {
      return requester<StabilityPoolDepositQuery, StabilityPoolDepositQueryVariables>(
        StabilityPoolDepositDocument,
        variables,
        options,
      ) as Promise<StabilityPoolDepositQuery>;
    },
    StabilityPool(variables: StabilityPoolQueryVariables, options?: C): Promise<StabilityPoolQuery> {
      return requester<StabilityPoolQuery, StabilityPoolQueryVariables>(
        StabilityPoolDocument,
        variables,
        options,
      ) as Promise<StabilityPoolQuery>;
    },
  };
}
