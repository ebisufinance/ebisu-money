	...
	generalInfotooltips: {
		...
		loanRedemptionRisk: [
			...
			<>
				...
				. Redemptions start from the lowest interest rate loans. Raise the
				interest rate on your loan to reduce the risk.
			</>,
		],
		loanLtv: [
			"Loan-to-value ratio",
	...
	home: {
		...
		actions: {
			borrow: {
				title: "Borrow ebUSD",
				description:
					"Set your own interest rate and borrow ebUSD against ETH and staked ETH.",
			},
			leverage: {
				title: "Leverage ETH",
				description:
