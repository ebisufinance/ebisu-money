...
export function EarnPoolsListScreen() {
  ...
  return (
    <Screen
      ...
      gap={16}
    >
      {collSymbols.map((symbol) => <Pool key={symbol} collSymbol={symbol} />)}
    </Screen>
  );
}
            ...
            >
              ...
              >
                ...
                <InfoTooltip heading="APR">
                  Annual percentage rate being earned by the {collateral.name}{" "}
                  stability pool’s deposits over the past 7 days.
                </InfoTooltip>
              </div>
            </div>
          </div>
